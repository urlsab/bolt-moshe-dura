...
const articles: Article[] = [
  {
    ...
    content: `
      ...
      <p>באיטליז למהדרין של משה דורא, אנו מקפידים על הסטנדרטים הגבוהים ביותר של כשרות, ומספקים רק בשר בהשגחת בד״ץ העדה החרדית ובכשרות יורה דעה מהודרת. אנו מזמינים אתכם להתרשם ממגוון המוצרים האיכותיים שלנו ולהתייעץ עם הצוות המקצועי שלנו בכל שאלה.</p>
    `,
    category: 'כשרות',
